...
namespace EW.PM {
    ...
    public class EWPMItemPropertyDetail:IBqlTable {
        ...
        public virtual int? ItemPropertyDetailID {
            get; set;
        }
        ...
        public virtual int? ItemPropertyID {
            get; set;
        }
        ...
        public virtual int? PropertyLineNbr {
            get; set;
        }
        ...
        [PXSelector(typeof(EWPMProperty.proprtyID),
                ...
                typeof(EWPMProperty.description), SubstituteKey = typeof(EWPMProperty.description), IsPrimaryViewCompatible = true
                )]
        ...
        */
        ...
        public virtual int? GroupLineNbr {
            get; set;
        }
