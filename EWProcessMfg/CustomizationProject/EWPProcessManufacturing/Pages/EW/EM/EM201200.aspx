                        ...
                        <Levels>
                            ...
                            <px:PXGridLevel DataKeyNames="ItemPropertyDetailID" DataMember="ItemPropertyDetails">
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXSelector ID="edPropertyID" runat="server" AlreadyLocalized="False" DataField="ItemPropertyID" AutoRefresh="true" CommitChanges="true" SyncStateWithCommand="true">
                                    </px:PXSelector>

                                  <%--  <px:PXMaskEdit ID="edPropertyType" en runat="server" AlreadyLocalized="False" DataField="EWPMProperty__Type">
                                    </px:PXMaskEdit>--%>

                                    <px:PXMaskEdit ID="edPropertyValue" runat="server" AlreadyLocalized="False" DataField="PropertyValue">
                                    </px:PXMaskEdit>

                                <%--    <px:PXMaskEdit ID="edPropertyUnit" runat="server" AlreadyLocalized="False" DataField="EWPMProperty__PropertyUnit">
                                    </px:PXMaskEdit>--%>

                                   <%-- <px:PXMaskEdit ID="edPropertyGroup" runat="server" AlreadyLocalized="False" DataField="EWPMProperty__Group">
                                    </px:PXMaskEdit>--%>
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ItemPropertyID" Width="150" CommitChanges="true" />
