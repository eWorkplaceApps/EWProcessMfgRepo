...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="ItemProperty" Style="z-index: 100" Width="100%">
        <Template>
            ...
            <px:PXTextEdit ID="edDescription"  runat="server" DataField="InventoryItem__Descr" Enabled="false" Width="450" />
        </Template>
    </px:PXFormView>
</asp:Content>
                        ...
                        <Levels>
                            ...
                            <px:PXGridLevel DataKeyNames="ItemPropertyDetailID" DataMember="ItemPropertyDetails">
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXSelector ID="edPropertyID" runat="server" AllowEdit="true" AlreadyLocalized="False" DataField="PropertyID" AutoRefresh="true" CommitChanges="true" SyncStateWithCommand="true">
                                    </px:PXSelector>

                                    <px:PXMaskEdit ID="edPropertyType" Enabled="false" runat="server" AlreadyLocalized="False" DataField="EWPMProperty__Type">
                                    </px:PXMaskEdit>

                                    <px:PXMaskEdit ID="edPropertyValue" runat="server" AlreadyLocalized="False" DataField="PropertyValue">
                                    </px:PXMaskEdit>

                                    <px:PXMaskEdit ID="edPropertyUnit" Enabled="false" runat="server" AlreadyLocalized="False" DataField="EWPMProperty__PropertyUnit">
                                    </px:PXMaskEdit>

                                    <px:PXMaskEdit ID="edPropertyGroup" Enabled="false" runat="server" AlreadyLocalized="False" DataField="EWPMProperty__Group">
                                    </px:PXMaskEdit>
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="EWPMProperty__Type" CommitChanges="true" />
                                    <px:PXGridColumn DataField="PropertyValue" Width="150" CommitChanges="true" />
                                    <px:PXGridColumn DataField="EWPMProperty__PropertyUnit" Width="150" CommitChanges="true" />
                                    <px:PXGridColumn DataField="EWPMProperty__Group" Width="150" CommitChanges="true" />
